...
const PaginaBase = ({ title, children, showHeader = true, showFooter = true, headerInfo }) => (
    <div className="w-[21.59cm] min-h-[27.94cm] relative p-12 flex flex-col bg-white shadow-md mb-8 mx-auto print:shadow-none print:mb-0 print:m-0 print:w-full print:min-h-0 print:p-0 print:block print:break-after-auto">
        {showHeader && (
        ...
        <div className="space-y-4 text-justify print:text-black">{children}</div>
        {showFooter && (
            <div className="mt-auto pt-6 border-t-2 border-slate-900 flex justify-between items-end text-xs font-bold text-gray-700 print:text-black print:mt-8 print:flex-row">
